...
| `04-frontend-plan.md` | Before any mobile work. The fourteen frontend stages, each with its TRD requirement and acceptance criterion, and a live status per stage. |
